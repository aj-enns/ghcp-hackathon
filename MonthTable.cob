      ...
      * Start of the identification division
       PROGRAM-ID.  MonthTable.
      * Program name
       AUTHOR.  Michael Coughlan.
      * Author name
      * This program counts the number of albums released in each month
      * and displays the result.

       ENVIRONMENT DIVISION.
      * Start of the environment division
       INPUT-OUTPUT SECTION.
      * Input-output section
       FILE-CONTROL.
      * File control section
           SELECT AlbumFile ASSIGN TO "ALBUMS.DAT"
      * Assign the file "ALBUMS.DAT" to AlbumFile
               ORGANIZATION IS LINE SEQUENTIAL.
      * The file is organized as a sequence of lines

       DATA DIVISION.
      * Start of the data division
       FILE SECTION.
      * File section
       FD AlbumFile.
      * File description for AlbumFile
       01 AlbumDetails.
      * Record description for AlbumDetails
      ...
      * Start of the working-storage section
       01 MonthTable.
      * Table to store the month names
          02 TableValues.
      ...
      * If end of file, set EndOfAlbumFile to true
               END-READ
               IF NOT EndOfAlbumFile
      * If not end of file
                   COMPUTE MonthIdx = MORelease
      * Compute the index for the month array
      ...
      * Increment the count for the month
           ...
           DISPLAY HeadingLine.
      * Display the heading for the output table
           PERFORM VARYING MonthIdx FROM 1 BY 1 UNTIL MonthIdx > 12
      * Loop through the month array
               DISPLAY Month(MonthIdx) " " MonthCount(MonthIdx)
      * Display the month name and count
           END-PERFORM.
